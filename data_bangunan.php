    ...
    <div style="opacity: 1;" class="widget-box  ui-sortable-handle light-border" id="widget-box-2">
       <div class="widget-header">
            ...
            <div class="widget-toolbar">
                <a href="form-bangunan.php" class="">
        ...
        <div class="widget-body">
            <div class="widget-main no-padding">
                ...
                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <?php
                        include("koneksi.php");
                            $query="SELECT id, jenis_bangunan, owner, id_bangunan, no_rumah, lokasi, alamat, kepala_keluarga, status FROM t_bangunan";
                    ...
                    ?>
                        <tr>
                            <td>1</td>
                            <td><?php echo $jenis_bangunan; ?></td>
                            <td><?php echo $id_bangunan; ?></td>
                            ...
                            <td><a href="bangunan.php?id=<?php echo $id; ?>"><span class="label label-info"> Details</span></a> <a href=""><span class="label label-warning">Edit</span></a> <a href=""><span class="label label-danger">Delete</span></a></td>
                        </tr> 
